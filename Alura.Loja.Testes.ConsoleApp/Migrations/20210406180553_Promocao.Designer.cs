...
namespace Alura.Loja.Testes.ConsoleApp.Migrations
{
    ...
    [Migration("20210406180553_Promocao")]
    partial class Promocao
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Alura.Loja.Testes.ConsoleApp.Entities.PromocaoProduto", b =>
                {
                    ...
                    b.HasKey("PromocoesId", "ProdutosId");
            ...
            modelBuilder.Entity("Alura.Loja.Testes.ConsoleApp.Entities.PromocaoProduto", b =>
                {
                    b.HasOne("Alura.Loja.Testes.ConsoleApp.Produto", "Produtos")
                        .WithMany("PromocaoProduto")
                        .HasForeignKey("ProdutosId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Alura.Loja.Testes.ConsoleApp.Entities.Promocao", "Promocoes")
                        .WithMany("PromocaoProduto")
